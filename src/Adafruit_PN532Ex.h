...
#ifndef ADAFRUIT_PN532EX_H
#define ADAFRUIT_PN532EX_H
...
class Adafruit_PN532Ex : public NFCInterface
{
 public:
  Adafruit_PN532Ex(uint8_t clk, uint8_t miso, uint8_t mosi, uint8_t ss);  // Software SPI
  Adafruit_PN532Ex(uint8_t irq, uint8_t reset);  // Hardware I2C
  Adafruit_PN532Ex(uint8_t ss);  // Hardware SPI
  void begin(void);
