...
class MFRC522Ex : public NFCInterface {
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522Ex(const byte chipSelectPin, const byte resetPowerDownPin,
	...
	MFRC522Ex() : MFRC522Ex(UNUSED_PIN, UNUSED_PIN) {};
	...
	virtual bool PICC_IsNewCardPresentWakeup();
	...
	bool SAMConfig();
	bool readID(uint8_t * uidVal, uint8_t * uidLength, uint16_t timeout);
